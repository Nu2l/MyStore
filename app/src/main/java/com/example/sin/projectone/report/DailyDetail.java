...
public class DailyDetail extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Cursor todoCursor = ProductDBHelper.getInstance(this.getActivity()).getDailyProduct(createAt);
        Cursor todoCursor2 = ProductDBHelper.getInstance(this.getActivity()).getDailyProduct(createAt);
        DailyProductCursor todoAdapter = new DailyProductCursor(this.getActivity(), todoCursor);
